...
try {
	...
	$inserir=$conexao->query("INSERT INTO pro (produto, marca, descricao, categoria, quantidade, preco, foto1, foto2, foto3)
	VALUES ('$recebe_produto', '$recebe_marca', '$recebe_descricao','$recebe_categoria', '$recebe_quantidade', '$recebe_preco', '$img_nome1', '$img_nome2', '$img_nome3')");
